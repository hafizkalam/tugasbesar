...
<html>
<head>
	<title>GreenShop - Pembayaran</title>
...
<!-- Sidebar -->
    ...
    <form>
    <div>Nama Anda : </div><?php echo $_SESSION['username']; ?>
    <br>
            <label for="alamat">Alamat Anda</label>
            <div class="form-group"><input class="form-control" type="text" name="alamat" placeholder="Alamat"></div>
            <label>Kuantitas</label>
            <br>
            <input type="number" id="quantity" name="quantity" min="1" max="10">   
            <br> <br>
			<div class="form-group"><button class="btn btn-primary btn-block">Beli</button></div>
